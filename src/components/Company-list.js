...
import loader from './market-research.gif';
...
class Companylist extends Component {
    ...
    render() {
        ...
        if (!isLoaded) {
            return (
                <center>
                    {/* <div className="lds-"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div> */}
